    ...
    <div id="grid">
      ...
      <div id="article">
        ...
        ?>                      <tr>
                        ...
                        <td width = "100" align = "center"><a href="./upload/<?php echo $rows['file'];?>" download><?php echo $rows['file']; ?></a></td>
                        <td width = "100" align = "center"><?php echo $rows['writer']?></td>
                        <td width = "100" align = "center"><a href = "modify3.php?number=<?php echo $rows['number']?>">수정</td>
                        <td width = "100" align = "center"><a href = "delete3.php?number=<?php echo $rows['number']?>">삭제</td>
